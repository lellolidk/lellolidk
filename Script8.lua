...
local Luxt = Luxtl.CreateWindow("Halal Hub | Clicking Simulator", 6105620301)
-- Tabs
...
Credits:Button("My Account", function()
    setclipboard("https://www.roblox.com/users/878683862/profile")
end)
